  ...
  try {
   ...
   // Configure options for sending confirmation emails to the sender and website owner
    ...
    options = {
      ...
      message_Content: `<p> Hi Pragati Rastogi, <br> You have received a new query from your Your Portfolio Website. The Sender Details are: <br> <b>Name : </b>${data.name} <br> <b>Email : </b> ${data.email} <br> <b>Message : </b> ${data.message} </p>`,
    };
